...
| 2b · geometry student | [Prepared comparison](2026-06-29-phase2b-prepared-blocked.md) | preflight pending | implementation-only | Corrected versioned split, VGGT/RGB/final/multi-layer comparison, three-seed training, online diagnostics, content-bound Slurm gates, and verified assets are ready. | Pass submitted CUDA/real-model preflight, run the unchanged protocol, then promote or reject the multi-layer student. |
