...
4. For geometry, the governed synthetic instrumentation preflight is complete and
   [Phase 2g-A quality-first architecture validation](2026-06-30-phase2g-quality-first-preregistered.md) is frozen for
   the authorized SUN development lineage. Execute M0-M3 fairly under the formal artifact graph; efficiency remains
   descriptive during selection and no result is promoted before terminal postflight.
